...
X_data = np.random.uniform(1, 10, (n_samples, 1)) #create 1000 random points in 0,1
y_data = 2 * X_data + 1 + np.random.normal(0, 2, (n_samples, 1)) #calculate for each point y = 2*x + 1 + e (e,0,2-variance)
